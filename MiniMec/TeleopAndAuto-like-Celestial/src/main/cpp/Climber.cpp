...
void Climber::CheckHomePositions() {
  ...
  frc::SmartDashboard::PutNumber("Port Climber", 0 /*mClimberPort.GetSelectedSensorPosition()*/);
  frc::SmartDashboard::PutNumber("Star Climber", 0 /*mClimberStar.GetSelectedSensorPosition()*/);
