...
public:
  AutonomousController (DriveSystem *drive, Shooter *shooter, Feeder *feeder); // constructor
  void AutonomousInit();
...
private:
  ...
  const std::string kAutoNameDriveAndShoot = "Drive + Shoot";
  const std::string kAutoNameDriveAndBlind = "Drive + Blind Shoot";
